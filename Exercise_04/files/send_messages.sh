...
for i in {1..100}; do
	...
	echo "light=" $light
	echo "------"
	#curl -v -k --cert-type PEM --cert pw_sensor_node_xx-device_certificate.pem:o6S9dYv9BVQsCsU6 -H "Content-Type: application/json" -d "{ \"capabilityAlternateId\":  \"f13de4527155ee15\", \"sensorAlternateId\": \"3a53c3a4ac1d4130\",\"measures\":[[32,[$humidity],[$light]}" https://weather-station.eu10.cp.iot.sap/iot/gateway/rest/measures/dc589032389d4044
	...
	sleep 2 #sleeps for every 2 seconds
done